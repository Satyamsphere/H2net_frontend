      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md animate-fade-in">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm">
              <Link to="/reset-password" className="font-medium text-h2net-blue hover:text-blue-500">
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/register" className="font-medium text-h2net-blue hover:text-blue-500">
              Sign up
            </Link>
          </p>
        </div>
